        ...
        <>
          {session ? (
            <Menu placement="bottom">
              <MenuHandler>
                <div class="relative cursor-pointer inline-flex items-center justify-center w-10 h-10 select-none overflow-hidden hover:opacity-80 bg-primary-200/25 rounded-full dark:bg-gray-600">
                  <span class="font-medium text-black uppercase">{`${session.user?.firstName[0]}${session?.user?.lastName[0]}`}</span>
                </div>
              </MenuHandler>
              <MenuList>
