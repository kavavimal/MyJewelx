        ...
        <div className="flex flex-col gap-5">
          ...
          <div>
            <div className="flex flex-col gap-4">
              <Button
                variant="outlined"
                className="rounded w-full border-secondary-200 text-secondary-200 font-emirates normal-case text-base"
            ...
            <div className="mt-2">
              <Typography className="font-emirates text-sm text-gray-700">
                ...
                and <Link href="#" className="text-primary-200">Privacy Policy</Link>
              </Typography>
            </div>
          </div>
        </div>
