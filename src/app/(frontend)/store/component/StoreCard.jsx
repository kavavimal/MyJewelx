...
const StoreCard = ({ list }) => {
  ...
  return (
    <Card className="rounded-sm relative bg-clip-border overflow-hidden border-blueGray-300 border">
      ...
      <CardBody className="px-[15px] pb-2 pt-3 border-b border-blueGray-300">
        <div className="flex flex-col gap-[0.5px]">
          <Link
            ...
            className="text-lg text-blueGray-500 text-center font-semibold hover:text-primary-200"
          >
            {list.vendor?.store_name ?? `${list.firstName} ${list.lastName}`}
          </Link>
          <p className="font-light leading-6 text-sm text-center">
            {list.vendor?.licence_address ||
              ...
              "The Gold Center Building" + ", " + list.vendor?.licence_state ||
              "Deira Dubai" + ", " + list.vendor?.licence_country ||
              "Dubai" + ", "}
          </p>
          <div className="flex justify-between items-center">
            <div>
              <p className="text-sm">{list?.phone_number ?? "+97 123-75678"}</p>
            </div>
        ...
        <div className="px-[15px] pt-[12.5px] pb-0 flex flex-col gap-[5px]">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-0.5 text-blueGray-700 text-sm">
              ...
              <span>{list?._count?.products}</span>
            </div>
          </div>
        </div>
