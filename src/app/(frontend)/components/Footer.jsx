...
function Icon({ id, open }) {
  return (
    <>
      ...
      >
        <path d="M21.5 3.49609H0.5V0.496094H21.5V3.49609Z" fill="#FFFFFF" />
      </svg>
    </>
  );
}
...
export default function Footer() {
  ...
  return (
    <>
      <footer className="footer pt-5 md:pt-16 bg-black md:bg-primary-250">
        <div className="footer-bar pb-4">
          <div className="container">
            <div className="flex flex-col md:flex-row items-start justify-between">
              <div className="w-full pb-[30px] md:pb-0 md:w-1/4 flex flex-col md:gap-5">
                <Link
                  href="/"
                  className="flex items-center space-x-3 rtl:space-x-reverse pb-[5px] md:pb-0"
                >
                  <Image
                    width={160}
                    height={160}
                ...
                <p className="text-secondary-50 tracking-wide pb-2.5 md:pb-0">
                ...
                <div>
                  <form className="flex">
                    <input
                      type="text"
                      name="search"
                      className="h-[42px] w-full md:w-[217.33px] rounded-s border-[#E6E6E6] border-s-[1.5px] border-y-[1.5px] focus:outline-none px-3 placeholder:text-secondary-100 text-secondary-100 "
                      placeholder="Your Email Address"
                    />
                    <Button className="hover:shadow-none border border-primary-200 hover:text-primary-200 hover:border-primary-200 hover:bg-transparent shadow-none outline-none rounded-s-none rounded-e focus:outline-none active:outline-none">
                      Subscribe
                    </Button>
                  </form>
                </div>
                ...
                <div className="md:hidden block">
                  ...
                  >
                    <AccordionHeader
                      ...
                      className="text-[16px] text-white md:text-blueGray-500 leading-[22.4px] font-emirates font-normal border-b-0 transition-colors !p-0 !pb-[10px] focus:text-white md:focus:text-blueGray-500"
                    >
                      Company
                    </AccordionHeader>
                    <AccordionBody className="text-[16px] !max-w-full  !min-w-full text-secondary-100 leading-[27.23px] font-emirates !w-full !mb-3 !p-0">
                      <ul>
                        <li>
                          <Link
                            href="/"
                ...
                <div className="md:hidden block">
                  ...
                  >
                    <AccordionHeader
                      ...
                      className="text-[16px] focus:text-white md:focus:text-blueGray-500 text-white md:text-blueGray-500  leading-[22.4px] font-emirates font-normal border-b-0 transition-colors !p-0 !pb-[10px] "
                    >
                      Help and Support
                    </AccordionHeader>
                    <AccordionBody className="text-[16px] !mb-3  text-secondary-100 leading-[27.23px] font-emirates !w-full !p-0">
                      <ul>
                        <li>
                          <Link
                            href="/"
              ...
              <div className="w-full flex justify-between pt-5 md:pt-0 md:block">
                <div className="stay-connected md:pb-8">
                  <h5 className="text-right text-[14px] text-white md:text-black md:text-xs pb-2.5 md:pb-4">
                    Stay Connected
                  </h5>
                  <ul className="flex gap-2 justify-start md:justify-end">
                    <li>
                      <Link href="/">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="payment-accept">
                  <h5 className="text-right text-[14px] text-white md:text-black md:text-xs pb-4">
                    Payment Accept
                  </h5>
                  <ul className="flex gap-[12px] md:gap-2 justify-end">
                    <li>
                      <Link href="/">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="copyright-bar ">
          <div className="container">
            <div className="flex md:flex-row flex-col-reverse justify-between items-center border-t pb-[17px] md:py-4">
              <div>
                <p className="text-[12px] text-[#808080] pt-2.5 md:pt-0">
                  2024 my jewlex All right reserved{" "}
                </p>
              </div>
              <div className="md:p-0 pt-5">
                <div className="flex gap-3 items-center">
                  <div>
                    <Link
                      href="/"
                      className=" text-[12px] text-[#808080] hover:text-black"
                    >
                      Privacy Policy
                    </Link>
                  </div>
                  <div className="border-t md:border-t-0 md:border-s h-3 border-secondary-50 border"></div>
                  <div>
                    <Link
                      href="/"
                      className=" text-[12px] text-[#808080] hover:text-black"
