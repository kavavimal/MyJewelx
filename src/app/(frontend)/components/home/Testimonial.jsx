      ...
      <AnimatePresence mode="wait">
        ...
        >
          <div className="container ">
            <div>
              <h3 className="text-2xl p-0 mt-4 sm:mb-5 font-playfairdisplay font-semibold">
                Testimonial
              </h3>
            </div>
            <div>
              ...
              >
                {new Array(5).fill(0).map((_, index) => (
                  <SwiperSlide key={index} className="sm:p-0 px-[1px] py-2.5">
              ...
              <div className="swiper-trend-pagination bottom-0 sm:hidden flex flex-wrap justify-center w-full items-center gap-1 sm:gap-[7px] pt-2.5"></div>
            </div>
          </div>
        </motion.section>
      </AnimatePresence>
