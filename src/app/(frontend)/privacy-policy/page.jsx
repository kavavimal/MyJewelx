    ...
    <section className="container">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to My Jewlex.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to My Jewlex, accessible from{" "}
            <a
              href="https://staging.myjewlex.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://staging.myjewlex.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://staging.myjewlex.com/update"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://staging.myjewlex.com/update
          </a>
        </li>
      </ul>
    </section>
