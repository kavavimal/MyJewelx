...
const Sidebar = () => {
  ...
  return (
    <aside className="w-1/5">
      <SimpleBar
        style={{ position: "sticky" }}
        className="top-5 left-0 border h-[94vh] border-[#cfd8dc] p-5 space-y-2 shadow bg-[#ffffff] mx-5 mt-5 mb-10 rounded-lg"
      >
                  ...
                  return (
                    ...
                    >
                      ...
                      <AccordionBody className={`px-0 py-0`}>
                        <List className="p-0 pt-2 min-w-full">
                            ...
                            if (
                              ...
                              return (
                                ...
                                >
                                  <ListItem
                                    key={childItem.name}
                                    className={`flex align-middle text-base select-none transition-all items-center py-4 px-4 font-emirates ${
                                      isActive(childItem.href)
                                        ? "bg-[#424242] hover:bg-[#414141] focus:bg-[#424242] text-white active:bg-[#424242] active:bg-opacity-100 focus:hover:bg-opacity-90 focus:bg-opacity-100 hover:bg-opacity-90 active:text-white"
                                        : "hover:bg-blueGray-100 bg-white"
                                    }`}
                                  >
                                    <ListItemPrefix>
                                      {childItem.icon}
